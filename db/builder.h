...
// @param skip_sync if true, skip file sync (caller must sync later)
// @param files_to_sync if provided and skip_sync=true, output file path for later sync
Status BuildTable(
    ...
    std::vector<std::string>* files_to_sync = nullptr);
