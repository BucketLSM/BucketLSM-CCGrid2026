...
class InternalStats {
 public:
  ...
  enum InternalCFStatsType {
    ...
    // Time (in microseconds) spent in each write stall cause
    MEMTABLE_LIMIT_DELAYS_MICROS,
    MEMTABLE_LIMIT_STOPS_MICROS,
    L0_FILE_COUNT_LIMIT_DELAYS_MICROS,
    L0_FILE_COUNT_LIMIT_STOPS_MICROS,
    PENDING_COMPACTION_BYTES_LIMIT_DELAYS_MICROS,
    PENDING_COMPACTION_BYTES_LIMIT_STOPS_MICROS,
    L0_FILE_COUNT_LIMIT_DELAYS_WITH_ONGOING_COMPACTION_MICROS,
    L0_FILE_COUNT_LIMIT_STOPS_WITH_ONGOING_COMPACTION_MICROS,
    BYTES_FLUSHED,
