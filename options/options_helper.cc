...
void BuildDBOptions(const ImmutableDBOptions& immutable_db_options,
  ...
  options.use_new_flush = immutable_db_options.use_new_flush; //jw
  options.parallel_split_flush = immutable_db_options.parallel_split_flush; //jw
  options.enable_intra_l0_compaction = immutable_db_options.enable_intra_l0_compaction; //jw
  options.l0_weight_compaction = immutable_db_options.l0_weight_compaction; //jw
  options.l0_file_count_weight = immutable_db_options.l0_file_count_weight; //jw
}
